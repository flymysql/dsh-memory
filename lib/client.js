...
// adds, and deletes vault entries through the package's private RPC.
import * as React from 'react'

export const name = 'dsh-memory'

// Talks to the host half through the official `webServer` service
// (same-origin JSON endpoints; see lib/index.js → "browser management page").
